package org.seekloud.theia.distributorPage.pages

import org.seekloud.theia.distributorPage.common.{Page, Routes}
import org.seekloud.theia.distributorPage.util.{Http, JsFunc}
import org.seekloud.theia.protocol.ptcl.distributor2Manager.DistributorProtocol.{CloseStreamReq, CloseStreamRsp, GetAllLiveInfoReq, GetAllLiveInfoRsp, liveInfo}
import io.circe.generic.auto._
import io.circe.syntax._
import mhtml.Var
import org.scalajs.dom
import org.seekloud.theia.distributorPage.Main
...
object AdminPage extends Page{
  ...
  def getAllLiveInfo: Future[Unit] = {
    val url = Routes.AdminRoutes.getAllLiveInfo
