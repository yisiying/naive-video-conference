package org.seekloud.theia.pcClient.core.player

import akka.actor.typed.scaladsl.{Behaviors, StashBuffer, TimerScheduler}
import akka.actor.typed.{ActorRef, Behavior}
import org.seekloud.theia.pcClient.component.WarningDialog
import org.seekloud.theia.pcClient.scene.{AutoResetSecene}
...
object VideoPlayer {
  ...
  def create(
    id: String,
    audienceScene: Option[AutoResetSecene] = None,
  ...
  private def idle(
    id: String,
    audienceScene: Option[AutoResetSecene],
    imageQueue: Option[immutable.Queue[AddPicture]] = None,
    samplesQueue: Option[immutable.Queue[Array[Byte]]] = None
  ): Behavior[PlayCommand] =
