...
import org.seekloud.theia.protocol.ptcl.CommonInfo.{ClientType, UserDes}
...
import org.seekloud.theia.webClient.common.Page
import org.seekloud.theia.webClient.common.Routes.rmWebScocketUri
import org.seekloud.theia.webClient.common.UserMsg._
import org.seekloud.theia.webClient.util.video.{exitFullScreen, fullScreen}
        ...
        <div class="roomContainer-main">
          ...
          <div class="chatsend">
            <div class="chatToolBar">
              <div class="ctb-item" ><img src="/theia/roomManager/static/img/表情.png" onclick={()=>showEmoji()}></img>
            ...
            <div class="pop-main-anImg">
              ...
              <div class="pop-content">
                ...
                if(i){
                  ...
                  //上传图片
                  <img id="test123" src="/theia/roomManager/static/img/默认图片.png" style="width:300px;height:250px;margin-bottom:20px"></img>
                }
              )}
                <div style="display:flex;justify-content:space-around">
                  <div class="upPhoto">
                    <img src="/theia/roomManager/static/img/上传图片.png"></img>
                    <div>上传图片</div>
                  </div>
                  ...
                  if(i){
                    <div class="takePhoto" onclick={()=> takephotoSure()} id="btn_snap" style="width:130px">
                      <img src="/theia/roomManager/static/img/拍照1.png"></img>
                      <div>点击拍照</div>
                    </div>
                  }else{
...
//    websocketClient.sendMsg(data)
  ...
  private def wsMessageHandler(data:WsMsgRm):Unit ={
    ...
    data match {
      ...
      case AudienceDisconnect(hostLiveId) =>
      //观众断开连线通知
...
//    dom.document.getElementById("imgBubble").setAttribute("style","display:none")
    ...
    currImgNum = headNum
    dom.document.getElementById("headImg").setAttribute("src","/theia/roomManager/static/img/headPortrait/"+headNum.toInt+".jpg")
  }
      ...
      <div style="width:70%">
        ...
        <div class="anchor-all" id="anchor-all" ondblclick={() => fullScreen()} >
          ...
          <div id="videoControlBottom" onmousemove={()=>showVideoCover()}>
            <div id="stop">
              <img src="/theia/roomManager/static/img/挂断.png" onclick={()=>stopAnchor()}></img>
            </div>
          </div>
          </div>
        </div>
