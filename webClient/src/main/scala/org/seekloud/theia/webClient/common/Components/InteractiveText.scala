...
import org.seekloud.theia.protocol.ptcl.client2Manager.websocket.AuthProtocol.{Comment, LikeRoom}
import org.seekloud.theia.webClient.actors.WebSocketRoom
import org.seekloud.theia.webClient.common.Routes
import org.seekloud.theia.webClient.util.{Globals, Http}
import io.circe.syntax._
import io.circe.generic.auto._
import mhtml.Var
import org.seekloud.theia.webClient.pages.{LivePage, MainPage}
...
//  val giftsList = List(
//    Gift(1, 8, "麻婆豆腐", "/theia/static/img/gifts/bread.png", "麻婆豆腐，是四川省传统名菜之一。这道菜突出了川菜“麻辣”的特点。其口味独特，口感顺滑。", "花费10金币，获得10点好感"),
//    Gift(2, 25, "北京烤鸭", "/theia/static/img/gifts/cake.png", "烤鸭是具有世界声誉的北京著名菜式。它以色泽红艳，肉质细嫩，味道醇厚，肥而不腻的特色，被誉为“天下美味”。", "花费15金币，获得10点好感"),
//    Gift(3, 28, "东坡肉", "/theia/static/img/gifts/broccoli.png", "东坡肉，又名滚肉、东坡焖肉，是眉山和江南地区特色传统名菜。它红得透亮，色如玛瑙，软而不烂，肥而不腻。", "花费2金币，获得10点好感"),
//    Gift(4, 18, "辣子鸡", "/theia/static/img/gifts/ice-cream.png", "辣子鸡，是一道经典的川渝地区的特色传统名肴。辣子鸡因各地的不同制作方法也有不同的特色。此菜色泽棕红油亮，麻辣味浓。", "花费8金币，获得10点好感"),
//    Gift(5, 21, "棒棒糖", "/theia/static/img/gifts/lollipop.png", "龙井虾仁是一道具有浓厚地方风味的杭州名菜。成菜后，虾仁白嫩、茶叶翠绿，色泽淡雅，味美清口。", "花费5金币，获得10点好感"),
//    Gift(6, 12, "八仙过海闹罗汉", "/theia/static/img/gifts/juice.png", "八仙过海闹罗汉是一道名菜，属于孔府菜。。旧时此菜上席即开锣唱戏，在品尝美味的同时听戏，热闹非凡，也奢侈至极。", "花费12金币，获得10点好感")
//  )
