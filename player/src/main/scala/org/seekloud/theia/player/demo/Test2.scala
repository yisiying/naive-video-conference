package org.seekloud.theia.player.demo
...
import org.seekloud.theia.player.protocol.Messages.AddPicture
...
class Test2 extends javafx.application.Application{
  ...
  override def start(primaryStage: Stage): Unit = {
    ...
    startBtn.setOnAction(_ => mediaActor.start(playId,videoPlayer,Left("rtmp://10.1.29.247:42037/live/123456"),Some(gc),None)) // 开始输出
