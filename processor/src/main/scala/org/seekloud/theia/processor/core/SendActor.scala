...
//import org.seekloud.theia.processor.core.ChannelWorker.{Ready, log, wait}
...
////          timer.startSingleTimer(ReAuthTimer,ReAuth(t.liveId, t.liveCode), 2.seconds)
...
//              null
//          }
//          output = if(socket!=null)socket.getOutputStream else null
//          if(socket==null) {
////            if(count<5)
//            socket.setTcpNoDelay(true)
...
//
//        case t:AuthRsp =>
////          timer.cancel(ReAuthTimer(t.liveId))
//          if(t.ifSuccess){
...
//          output = if(socket!=null){
//            socket.setTcpNoDelay(true)
//            socket.getOutputStream} else null
//          if(socket==null) {
//            //            if(count<5)
//            timer.startSingleTimer(Time4ReConnect,ReConnectSocket,10.seconds)
//          } else{
//            log.info(s"sendActor reConnect tcp to distributor successfully")
//            work(client)
//          }
//          Behaviors.same
//
...
////            case e: Exception =>
////              log.info(s"sendActor connect tcp to $distributorHost failed $e")
////              ctx.self ! SendActor.ReConnectSocket
////          }
//          Behaviors.same
//
