...
//import org.seekloud.theia.processor.Boot.{grabberManager, recorderManager}
//import org.seekloud.theia.processor.core.RecorderActor.NewFrame
...
//      msg match {
//          //由GrabberMangerActor发送过来，把RecorderActor的引用发送过来
//        case m@Recorder(rec) =>
...
//          //如果是主播，向RecorderActor发送UpdateRecorder消息
//          if(role == "host") {
