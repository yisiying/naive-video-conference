...
//import org.seekloud.theia.processor.protocol.SharedProtocol.{MpdRsp, RoomInfo, RtmpRsp}
//import java.util.concurrent.atomic.AtomicLong
//
//import org.seekloud.theia.processor.common.AppSettings._
//import org.seekloud.theia.processor.Boot.{executor, sendActor}
//import org.seekloud.theia.processor.models.MpdInfoDao
//import org.seekloud.theia.processor.utils.RMClient
///**
//  * User: yuwei
//  * Date: 7/15/2019
//  */
...
//            log.info(s"return liveId ${rtmpOpt.get} ---------")
//          }else{
//            reply ! MpdRsp("","",100024, "resources do not exist")
//            log.info(s"return no liveId --------")
//          }
//          Behaviors.same
//
...
//    val childName = s"recorderActor_${roomId}_${roomInfo.roles.head}"
...
//    val childName = s"wrapperActor_${roomId}_$liveId"
//    ctx.child(childName).getOrElse {
