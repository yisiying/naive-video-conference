...
import org.seekloud.theia.webrtcServer.Boot.rtpClientActor
...
object SendPipeline {
  ...
  val sourcePool: mutable.HashMap[String, (SourceChannel, ActorRef[LiveActor.Command])] = mutable.HashMap.empty
}
