...
public class HelloSkeleton extends SimpleApplication {
    ...
    public final static String SmileUp= "smileUp";

    public final static String SmileDown= "smileDown";
    ...
    private Vector3f lsrV = new Vector3f();
    private Vector3f lslV = new Vector3f();
    ...
    public void simpleInitApp() {
        ...
        jaime = (Node)assetManager.loadModel("Jaime/Jaime.j3o");
...
//        animControl.createChannel().setAnim("Walk");
        ...
        inputManager.addMapping(SmileUp, new KeyTrigger(KeyInput.KEY_G));
        inputManager.addMapping(SmileDown, new KeyTrigger(KeyInput.KEY_H));

        inputManager.addListener(actionListener,
                TOGGLE_SKELETON_DEBUGGER, TOGGLE_SKELETON_CONTROL, TOGGLE_ATTACHMENT, SmileUp, SmileDown);
    }
        ...
        public void onAction(String name, boolean isPressed, float tpf) {
            if (isPressed) {
                if (TOGGLE_SKELETON_DEBUGGER.equals(name)) {
                    ...
                    toggleAttachment();
                } else if (SmileUp.equals(name)) {
                    smileUp();
                } else if (SmileDown.equals(name)) {
                    smileDown();
                }
    ...
    private void smileUp() {
        lsrV.addLocal(0.005f, 0.005f, 0.0f);
        lslV.addLocal(-0.005f, 0.005f, 0.0f);
        lipSideR.setUserTransforms(lsrV, new Quaternion(), Vector3f.UNIT_XYZ);
        lipSideL.setUserTransforms(lslV, new Quaternion(), Vector3f.UNIT_XYZ);
