package org.seekloud.theia.faceAnalysis.ffmpeg;
...
public class WebcamAndMicrophoneCapture
{
    ...
    final private static int AUDIO_CHANNEL = 1;
    ...
    public static void main(String[] args) throws Exception, org.bytedeco.javacv.FrameGrabber.Exception
    {
        ...
        final FFmpegFrameRecorder recorder = new FFmpegFrameRecorder(
                "test.ts",
                captureWidth, captureHeight, AUDIO_CHANNEL);
        ...
        new Thread(new Runnable() {
            ...
            public void run()
            {
                ...
                AudioFormat audioFormat = new AudioFormat(44100.0F, 16, AUDIO_CHANNEL, true, false);
