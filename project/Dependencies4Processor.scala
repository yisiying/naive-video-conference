...
object Dependencies4Processor {
  ...
  val backendDependencies =
    Dependencies4Processor.akkaSeq ++
      Dependencies4Processor.akkaHttpSeq ++
      Dependencies4Processor.circeSeq ++
      Seq(
        Dependencies4Processor.scalaXml,
        Dependencies4Processor.slick,
        Dependencies4Processor.slickCodeGen,
        Dependencies4Processor.nscalaTime,
        Dependencies4Processor.hikariCP,
        Dependencies4Processor.logback,
        Dependencies4Processor.codec,
        Dependencies4Processor.postgresql,
        Dependencies4Processor.asynchttpclient,
        Dependencies4Processor.ehcache,
        Dependencies4Processor.byteobject,
        Dependencies4Processor.mail
//        Dependencies4Processor.oshi
      )
